...
export default class ConductorSignupScreen extends React.Component {

  constructor(props) {
    super(props)
    this.state = {
      firstName: '', lastName: '', nic: '', phoneNo: '', email: '', password: '', roleId: '', regNo:'',error:''
    }
  }
  ...
  render() {
    ...
    return (
      <View style={styles.container}>
        ...
        <Text style={{ fontSize: 30, position: 'absolute', top: 15, color: '#22AFD1' }}> Create Your Account </Text>
