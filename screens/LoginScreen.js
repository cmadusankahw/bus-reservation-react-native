...
export default class LoginScreen extends React.Component {
  ...
  Login = async () => {
    ...
    fetch("http://localhost:8012/basic/web/index.php?r=user/login-validation", {
      method: "POST",
      mode: "cors",
  ...
  render() {
    return (
      <View style={styles.container}>
        ...
        <Text style={{ position: "absolute", top: 380, color: "#71D3E7" }}>
          Don't have an account yet ?
        </Text>
        <TouchableOpacity
          onPress={() => this.props.navigation.navigate("RolleSelectionScreen")}
          style={{ position: "absolute", top: 400 }}
        >
          <Text style={{ color: "#71D3E7" }}> SignUp </Text>
        </TouchableOpacity>
      </View>
    );
  }
